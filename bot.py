...
# === Поиск товаров через API Wildberries (исправлено и работает) ===
def search_wb(query: str) -> list:
    ...
    try:
        ...
        logger.info(f"✅ Найдено {len(products)} товаров в ответе")
        ...
        # Сортировка: по отзывам (по убыванию), затем цена (по возрастанию)
